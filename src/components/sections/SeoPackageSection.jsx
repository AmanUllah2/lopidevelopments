...
const frequencies = [
  ...
  { value: "annually", label: "Annually", priceSuffix: "/per month" },
];
...
const tiers = [
  {
    name: "Organic",
    id: "organic",
    price: { monthly: "$1,000", annually: "$900" },
  ...
  },
  {
    name: "Focused",
    id: "focused",
    price: { monthly: "$2,000", annually: "$1,800" },
    description:
      "Comprehensive search engine optimization package for businesses serious about online visibility.",
    features: [
  ...
  },
  {
    name: "Premium Tier",
    id: "premium-tier",
    price: { monthly: "$4,000", annually: "$3,600" },
    description:
      "Comprehensive search engine optimization package for large enterprises seeking maximum online visibility.",
    features: [
      ...
      { item: "Full Technical search engine optimization" },
        ...
        <Container>
          ...
          <div className="mt-6 flex justify-center items-center gap-4">
            ...
            <div className="flex items-center gap-1 py-1 px-3 rounded-full border border-[#138867] bg-[#EEFBF5]">
              ...
              <span className="text-[#138867]">(save 10%)</span>
            </div>
          </div>
                      ...
                      {tier.features.map((feature) => (
                        <li key={feature} className="flex gap-x-3">
                          {feature.notAvailable ? (
                            ...
                            <CheckIcon
                              className={`h-6 w-5 flex-none text-[#138867]`}
                            />
                          )}
...
export default SeoPackageSection;
